...
{#if processingImage}
  <div role="status" class="flex justify-center py-24">
    <svg
      aria-hidden="true"
      class="w-36 h-36 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
      viewBox="0 0 100 101"
      fill="none"
...
<a
  ...
  href={$modifiedImage}
  target="_blank"
  class="bg-blue-500 hover:bg-blue-700 block text-xl w-full font-bold rounded-full px-4 py-2 text-white mt-10"
>
  Download image
</a>
